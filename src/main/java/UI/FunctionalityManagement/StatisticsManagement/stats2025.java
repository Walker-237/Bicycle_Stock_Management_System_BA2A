 ...
 * @author Walker
 */
public class stats2025 extends javax.swing.JFrame {
    ...
    public stats2025(String username) {
        initComponents();
         displayChart();
...
private void displayChart() {
    ...
    try (Connection con = DriverManager.getConnection(url, user, password);
         PreparedStatement stmt = con.prepareStatement("SELECT month, noOfSales FROM statistics WHERE year = 2025 ORDER BY month ASC");
