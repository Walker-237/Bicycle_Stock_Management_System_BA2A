 ...
 * @author Walker
 */
public class stats20221 extends javax.swing.JFrame {
    ...
    public stats20221(String username) {
        initComponents();
         displayChart();
...
private void displayChart() {
    ...
    try (Connection con = DriverManager.getConnection(url, user, password);
         PreparedStatement stmt = con.prepareStatement("SELECT month, noOfSales FROM statistics WHERE year = 2022 ORDER BY month ASC");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(stats20221.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new stats20221(username).setVisible(true);
            }
        });
    }
